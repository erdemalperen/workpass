-- Fix analytics functions to use 'status' instead of 'is_active'
-- Businesses and passes tables use 'status' column, not 'is_active'

-- Drop and recreate get_dashboard_stats with correct column
